...
<html lang="en">
    <head>
       ...
       {{-- Laravel Mix - CSS File --}}
        @vite(['packages/Cybercraftit/Aster/src/Modules/Admin/Resources/assets/sass/admin.scss'])
        @yield('css')
    </head>
    <body>
    @php
...
<!--        new bootstrap theme ends -->
    ...
    @vite(['packages/Cybercraftit/Aster/src/Modules/Admin/Resources/assets/js/admin.js'])
